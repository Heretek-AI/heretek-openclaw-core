---
name: backup-ledger
description: Backup consensus ledger and curiosity metrics databases with versioned snapshots. Use when the collective needs to preserve deliberation history, create recovery points, or archive autonomy metrics.
---

# Backup Ledger — Consensus History Preservation

**Purpose:** Create versioned backups of consensus ledger and curiosity metrics.
...
- **Triad Resilience:** Recovery from corruption
- **Cron Manager:** Scheduled daily backups
- **Curiosity Engine:** Metrics preservation

---

**Consensus preserved. History backed up. Recovery ready.** 🦞
